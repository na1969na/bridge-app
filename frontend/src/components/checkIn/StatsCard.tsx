...
const StatsCard: React.FC = () => {
  ...
  return (
    <div className="p-6 rounded-3xl bg-stone-100 flex flex-col justify-between w-1/3 animate-slide-up">
      ...
      <div className="flex flex-col gap-5">
        {stats.map((stat, index) => (
          ...
          >
            <h3 className="text-xl font-semibold px-10 py-3">{stat.title}</h3>
            <p
              className={cn(
